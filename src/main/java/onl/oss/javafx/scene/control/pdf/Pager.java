...
public final class Pager extends HBox {
	...
	public final IntegerProperty maxPageIndexProperty() {
	...
	public Pager() {
		getStylesheets().add(Pager.class.getResource("Pager.css").toExternalForm());
