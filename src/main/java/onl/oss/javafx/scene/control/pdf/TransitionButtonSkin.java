...
public final class TransitionButtonSkin extends ButtonSkin {
	...
	private ObjectProperty<Color> textColorProperty = new SimpleObjectProperty<Color>(Color.TRANSPARENT);
	private ObjectProperty<Color> backgroundColorProperty = new SimpleObjectProperty<Color>(Color.TRANSPARENT);
	private DoubleProperty opacityProperty = new SimpleDoubleProperty(0.0);
	private OpaqueBackgroundBinding backgroundBinding = new OpaqueBackgroundBinding(backgroundColorProperty, opacityProperty);
